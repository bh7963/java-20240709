...
//	접근제어자가 public 이기때문에 외부 패키지에서 접근 가능 
	instance.publicVariable = 0;
	
//	protectedVariable, defaultVariable, privateVariable 필드는
	// 접근제어자가 각자 protected, default, private 이기때문에 외부 패키지에서 접근이 불가능
...
//		AccessModifier의 publicVariable, protectedVariable필드는
//		접근제어자가 각자 public, protected 이기때문에 자손 클래스에서 접근이 가능
		super.publicVariable = 0;
		super.protectedVariable = 0;
		
//		AccessModifier의 defaultVariable, privateVariable 필드는
//		접근제어자가 각각 default, private 이기때문에 자손 클래스에서 접근이 불가능
